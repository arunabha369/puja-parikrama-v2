                ...
                {filteredPandals.length > 0 ? (
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredPandals.map((pandal, index) => (
                            <div
                                key={index}
                                className="glass-card group flex flex-col h-full animate-fade-in-up"
                            ...
                            >
                                <div className="relative h-48 mb-4 rounded-xl overflow-hidden">
                                    ...
                                    <div className="absolute bottom-3 left-3 right-3">
                                        <h3 className="text-xl font-bold text-white font-cinzel leading-tight">{pandal.name}</h3>
                                    </div>
                                </div>
                                ...
                                <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center text-xs text-white/50">
                                    ...
                                    <span className="px-2 py-1 rounded bg-white/10">{index + 1}</span>
                                </div>
                            </div>
                        ))}
                    </div>
